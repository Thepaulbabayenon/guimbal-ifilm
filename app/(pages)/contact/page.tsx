              ...
              <div className="space-y-6 text-gray-300">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1">thebantayanfilmfestival@gmail.com<br />or support@ifilmplatform.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                ...
                <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                  <div className="sm:col-span-1">
                    ...
                    <input
                      ...
                      className="mt-1 py-3 px-4 block w-full shadow-sm rounded-md bg-gray-700 border-gray-600 text-white focus:ring-red-500 focus:border-red-500"
                    />
                  </div>
